...
import { AZURE_STORAGE_CONNECTION_STRING } from '../constants.js';

const blobServiceClient = BlobServiceClient.fromConnectionString(
  AZURE_STORAGE_CONNECTION_STRING
);

const containerName = 'newsletter-images';
...
export const processDownload = async (req, res) => {
  ...
  try {
    ...
    console.log(
      `Download abgeschlossen. Dateigröße: ${downloadBlockBlobResponse.contentLength}
Bytes`
    );
